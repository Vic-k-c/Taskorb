...
CREATE TABLE IF NOT EXISTS organizations (
  ...
  -- failed but still within the grace window (full access); canceled =
  -- access continues until current_period_end, then lazily reverts to free.
  subscription_status TEXT NOT NULL DEFAULT 'none' CHECK (subscription_status IN ('none','active','grace','canceled')),
