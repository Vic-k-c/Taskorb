...
const ICONS = {
  ...
  soul_winning: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
  <path d="M12 21C12 21 3 14.5 3 9.5 3 6.5 5.5 4.5 8 4.5c1.74 0 3.41 1.01 4 2.5.59-1.49 2.26-2.5 4-2.5 2.5 0 5 2 5 5 0 5-9 11.5-9 11.5z" />
  <path d="M8.3 12l2.2 2.2 4.7-4.7" />
</svg>
`,
