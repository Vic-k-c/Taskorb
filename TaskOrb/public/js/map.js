(function () {
  ...
  // CARTO's Voyager style: richer and more Google-Maps-like than plain OSM
  // tiles -- labeled roads, building footprints, and points of interest
  // (shops, institutions, etc.) at a similar zoom threshold, still free and
  // keyless. Subdomains a-d spread tile requests across CARTO's CDN.
    ...
    onAdd: function () {
      ...
      function render() {
        el.style.backgroundImage = onSatellite
          ...
          : "url('https://a.basemaps.cartocdn.com/rastertiles/voyager/3/2/2.png')";
