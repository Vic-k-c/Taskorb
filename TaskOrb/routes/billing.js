...
const { planList, getPlan, getOrgUsage } = require('../lib/plans');
...
// --- Paystack redirects here after checkout. This is best-effort
// immediate UX only -- the webhook (routes/webhooks.js) is the source of
// truth for actually activating the plan, since a person can close this
// tab before the redirect completes and the webhook would still fire. ---
