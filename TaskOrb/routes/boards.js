...
const { requireBoardLimit, getLockedBoardIds } = require('../lib/plans');
...
router.post('/boards', requireAuth, requireOrg, requireBoardLimit, async (req, res) => {
