...
router.get('/tags', requireAuth, requireOrg, requireOrgRole('admin'), requireFeature('hasOrgTags'), async (req, res) => {
...
router.post('/tags', requireAuth, requireOrg, requireOrgRole('admin'), requireFeature('hasOrgTags'), async (req, res) => {
