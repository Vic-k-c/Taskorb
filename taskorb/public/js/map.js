(function () {
  ...
  // --- Filter panel: board / list / priority ---
  ...
  let allPins = [];
  const filterState = { boardId: '', listId: '', priority: '' };
  ...
  const FilterControl = L.Control.extend({
    ...
    onAdd: function () {
      ...
      const prioritySel = panel.querySelector('#filterPriority');
      ...
      prioritySel.addEventListener('change', () => { filterState.priority = prioritySel.value; renderFilteredPins(); });
      clearBtn.addEventListener('click', () => {
        filterState.boardId = ''; filterState.listId = ''; filterState.priority = '';
        boardSel.value = ''; prioritySel.value = ''; listSel.value = ''; listSel.disabled = true;
        listSel.innerHTML = '<option value="">All lists</option>';
        renderFilteredPins();
      });
